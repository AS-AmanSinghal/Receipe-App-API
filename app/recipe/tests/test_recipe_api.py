...
class RecipeImageUploadTest(TestCase):
    ...
    def test_filter_recipe_by_tags(self):
        """Test returnning specific tags"""
        recipe1 = sample_recipe(user=self.user, title='NEW 1')
        recipe2 = sample_recipe(user=self.user, title='NEW 2')
        tag1 = sample_tag(user=self.user, name='TAG 1')
        tag2 = sample_tag(user=self.user, name='TAG 2')
        recipe1.tags.add(tag1)
        recipe2.tags.add(tag2)
        recipe3 = sample_recipe(self.user, title="New 3")
    ...
    def test_filter_recipe_by_ingredient(self):
        recipe1 = sample_recipe(user=self.user, title="New 1")
        recipe2 = sample_recipe(user=self.user, title='New 2')
        recipe3 = sample_recipe(user=self.user, title='New 3')
